      ...
      <div className="container">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            <div className="p-2 rounded shadow grid grid-cols-8 items-start gap-3">
              <div className="mt-2 w-[50px] h-[50px] bg-secondary/10 border border-secondary/50 rounded-xl flex items-center justify-center">
                <ImHappy className="text-secondary text-2xl" />
              </div>
            ...
            <div className="p-2 rounded shadow grid grid-cols-8 items-start gap-3">
              ...
              <div className="col-span-7">
                ...
                <p className="text-neutral-content text-sm">
                  Our punctuality is our promise. We know how important timing
                  is to you, so we try to deliver every task on time. Count on
                  us for reliable, on-time delivery every time!
                </p>
              </div>
            </div>
            <div className="p-2 rounded shadow grid grid-cols-8 items-start gap-3">
              ...
              <div className="col-span-7">
                ...
                <p className="text-neutral-content text-sm">
                  ...
                  engagement, loyalty, and lasting impact in a competitive
                  digital landscape.
                </p>
              </div>
            </div>
          ...
          <div>
            <Image
              ...
              width={500}
              height={500}
              className="w-[77%] h-[520px] md:mr-auto rounded-tl-[120px] rounded-br-[120px] rounded-tr-xl rounded-bl-xl object-cover"
              loading="lazy"
            />
          </div>
        </div>
